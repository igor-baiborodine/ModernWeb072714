...
public class SwingActionListener {
        ...
        public static void main(String[] args) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    System.out.println("Do something in this thread the old way");
                }
            }).start();

            new Thread(() -> {
                System.out.println("Do something in this thread with lambdas");
                try {
                    Thread.sleep(2000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                }
                System.out.println("Done doing something in this thread with lambdas");
            }).start();
